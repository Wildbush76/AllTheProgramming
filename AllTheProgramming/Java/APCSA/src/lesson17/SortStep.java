...
public class SortStep {
    ...
    public void sortMenu() {
        ...
        do {
            ...
            System.out.println("(7) non-recursive mergesort");
            ...
            if ('1' <= choice.charAt(0) && choice.charAt(0) <= '8') {
                ...
                if ('1' <= choice.charAt(0)
                        && (choice.charAt(0) <= '4' || choice.charAt(0) == '7' || choice.charAt(0) == '8')) {
                    System.out.println();
